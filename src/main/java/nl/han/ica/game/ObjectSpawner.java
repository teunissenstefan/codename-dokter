...
public class ObjectSpawner implements IAlarmListener {
    ...
    public void triggerAlarm(String alarmName) {
        ...
        int rnumber0 = random.nextInt(world.getLevel().worldHeight-50);
        int rnumber1 = random.nextInt(world.getLevel().worldHeight-50);
        ...
        world.addGameObject(block, world.getLevel().worldWidth, rnumber0);
        ...
        world.addGameObject(coin,world.getLevel().worldWidth, rnumber1);
